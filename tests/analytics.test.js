...
describe('Analytics', function () {
  ...
  describe('third-party requests', function () {
    ...
    it('serves Pure.css and each theme\'s heading webfont from this origin', async function () {
      // Dark renders headings in Bebas Neue, light in Schoolbell — neither
      // loads unless it's the one actually applied, so each needs its own
      // colour scheme rather than one shared assertion.
      for (const [colorScheme, font] of [['dark', 'Bebas Neue'], ['light', 'Schoolbell']]) {
